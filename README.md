...
```
cd existing_repo
git remote add origin https://git.chalmers.se/courses/dit638/students/2024-group-15.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.chalmers.se/courses/dit638/students/2024-group-15/-/settings/integrations)
